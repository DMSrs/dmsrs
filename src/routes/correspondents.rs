...
pub fn correspondent_add_post<'a>(rh: State<'a, RoutesHandler>, _path: State<Arc<RocketPath>>, data: Form<AddCorrespondentForm>) -> Redirect {
...
pub fn correspondent_delete<'a>(rh: State<'a, RoutesHandler>, _path: State<Arc<RocketPath>>, id: i32) -> Redirect {
